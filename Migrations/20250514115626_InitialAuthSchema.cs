        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_auth_Profiles_auth_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "auth_Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_auth_Addresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_auth_Addresses_auth_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "auth_Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_auth_Addresses_ProfileId",
                table: "auth_Addresses",
                column: "ProfileId");
